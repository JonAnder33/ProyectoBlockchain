...
exports.createSchema = async function (name, version, attributes) {
    ...
    numero=numero+1;
    //await exports.blockchain.obtainLatestBlock(); 
    //indy.blockchain.obtainLatestBlock();
    //URGENTE HABLARLO
    //let bloqueee = await exports.blockchain.creaBlock(numero,Date.now,attributes,dato);
